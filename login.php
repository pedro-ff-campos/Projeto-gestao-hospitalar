...
<?php 
// ==========================================================================
// 1. CODIGO PHP DE VALIDAÇÃO (O código seguro que corrigimos fica aqui no topo)
// ==========================================================================
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user && password_verify($password, $user['password'])) {
        ...
        $detalhes_erro = "Tentativa de login falhada para o e-mail: " . $email;
        $log_stmt = $pdo->prepare('INSERT INTO logs (utilizador_id, acao, detalhes, criado_at) VALUES (?, ?, ?, NOW())');
        $log_stmt->execute([null, 'LOGIN_FALHADO', $detalhes_erro]);
    }
}
?>
