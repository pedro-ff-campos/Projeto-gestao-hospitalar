...
<section id="sobre">
    <div>
        <div>
            <span>Sobre Nós</span>
            <h2>Uma empresa focada na saúde digital</h2>
            <p>
        ...
        <div>
            <div>
                ...
                <p>Todos os equipamentos e documentação num único sistema organizado.</p>
            </div>
            <div>
                <h4>Localização em tempo real</h4>
                <p>Rastreie onde cada equipamento está dentro do hospital.</p>
            </div>
            <div>
                <h4>Gestão documental</h4>
                <p>Manuais, certificados, contratos e muito mais sempre acessíveis.</p>
            </div>
            <div>
                <h4>Alertas automáticos</h4>
                <p>Notificações de garantias a expirar e manutenções pendentes</p>
            </div>
        </div>
    </div>
</section>
...
<section id="porque">
    <div>
        ...
        <h2>Desenvolvido especificamente para hospitais</h2>
        <p>Não somos uma solução genérica. O MedInvent foi concebido para responder às necessidades reais da gestão tecnológica em saúde.</p>
    </div>
    <div>
        <article>
            <h3>100% Web</h3>
            <p>Sem instalações. Acede a partir de qualquer computador com browser, dentro da rede hospitalar.</p>
        </article>
        <article>
            <h3>Base para CMMS</h3>
